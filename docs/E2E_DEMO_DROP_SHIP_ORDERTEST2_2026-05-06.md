# E2E Drop-Ship Demo — Etsy → Odoo → Gearment (2026-05-06)
...
|---|---|---|---|
| 0 | PASS | version=19.0-20260324; removed 1 demo design.file from prior runs | docs/screenshots/2026-05-06/drop_ship_00_landing.png |
...
| 2 | PASS | order form + Operations Dashboard rendered (id=30) | docs/screenshots/2026-05-06/drop_ship_02_order_form.png | docs/screenshots/2026-05-06/drop_ship_02_dashboard.png |
| 3 | PASS | attached 1 DEMO design.file row(s) (storage_mode='small'; line ids: [30]) | — |
| 4 | PASS | states={'approved'} (n=1) | — |
| 5 | PASS | GDrive sync deferred (killswitch='False'); all 1 approved design.file rows held on server at storage_mode='small'. Will resume on flip to 'True'. | — |
...
| 9 | PASS | tracking_state=shipped shipping_date=2026-05-06 | — |
| 10 | PASS | webhook status=200 body='{"status": "ok"}' | — |
| 11 | PASS | chatter has 21 message(s) on sale.order id=30 | — |
