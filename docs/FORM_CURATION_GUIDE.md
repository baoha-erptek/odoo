...
| `etsy.shop` (Flow 2) | All shop config + Publisher Defaults tab | Tier 1: name, etsy_api_shop_id, active_source; Tier 2 tabs (API Status / Publisher Defaults / Sync Health); Tier 3 group_system (debug fields, internal probe metrics) |
