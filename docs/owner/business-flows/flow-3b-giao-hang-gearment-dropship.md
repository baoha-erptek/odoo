...
> **Trạng thái triển khai:** Ảnh bên dưới là *stub preview* — module
> `gearment_integration` (gearment.order / quote.wizard / gearment.api.log)
> đang trong giai đoạn build. Sẽ thay bằng ảnh chụp thật khi pilot vendor
> approval xong.
...
> ![Gearment Quote Wizard (đang phát triển)](./screenshots/flow-3b/01-quote-wizard.png "Wizard — chọn SKU + shipping method")
...
> ![Gearment Order Form (đang phát triển)](./screenshots/flow-3b/02-gearment-order.png "Gearment order — trạng thái Submitted")
...
> ![Gearment Webhook Log (đang phát triển)](./screenshots/flow-3b/03-webhook-log.png "ir.logging — Gearment webhook receive")
