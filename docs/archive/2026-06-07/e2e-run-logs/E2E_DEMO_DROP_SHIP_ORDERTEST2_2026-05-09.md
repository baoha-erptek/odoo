...
|---|---|---|---|
| 0 | PASS | version=19.0-20260324; removed 3 demo design.file from prior runs | docs/screenshots/2026-05-09/drop_ship_00_landing.png |
| 1 | PASS | FALLBACK to existing demo order S00043 (Gmail OAuth not provisioned — no fresh email logs in last 2h). partner=Andrea Flint | — |
| 2 | PASS | order form + Operations Dashboard rendered (id=43) | docs/screenshots/2026-05-09/drop_ship_02_order_form.png | docs/screenshots/2026-05-09/drop_ship_02_dashboard.png |
| 3 | PASS | attached 2 DEMO design.file row(s) (storage_mode='small'; line ids: [63, 64]) | — |
| 4 | PASS | states={'approved'} (n=2) | — |
| 5 | PASS | all 2 approved design.file rows promoted to gdrive; first gdrive_file_id=1CCx3DT-Xgvdn62ahbalP3GwcFTN8zx5S | — |
...
| 9 | PASS | tracking_state=shipped shipping_date=2026-05-09 | — |
| 10 | PASS | webhook status=200 body='{"status": "ok"}' | — |
| 11 | PASS | chatter has 8 message(s) on sale.order id=43 | — |
