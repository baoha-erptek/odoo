# E2E Drop-Ship Demo — Etsy → Odoo → Gearment (2026-05-08)
...
|---|---|---|---|
| 0 | PASS | version=19.0-20260324; removed 1 demo design.file from prior runs | docs/screenshots/2026-05-08/drop_ship_00_landing.png |
| 1 | PASS | newest ordertest2 ingest: S00042 etsy_order_id=3710809073 total=18.21 partner=Charles Nepomuceno (4 candidate(s) in last 2h) | — |
| 2 | PASS | order form + Operations Dashboard rendered (id=42) | docs/screenshots/2026-05-08/drop_ship_02_order_form.png | docs/screenshots/2026-05-08/drop_ship_02_dashboard.png |
| 3 | PASS | attached 3 DEMO design.file row(s) (storage_mode='small'; line ids: [60, 61, 62]) | — |
| 4 | PASS | states={'approved'} (n=3) | — |
| 5 | PASS | all 3 approved design.file rows promoted to gdrive; first gdrive_file_id=1trEzWrTgFUm3pJGeDKKq5jGyBNVmhOti | — |
| 6 | PASS | pipeline_state_id=8 outbound_ref=∅ outbound_api_logs=2 latest_endpoint=POST /api/v3/orders http_status=0 (non-200 means live Gearment API rejected the synthetic order; the wiring fired regardless — see chatter) | — |
...
| 9 | PASS | tracking_state=shipped shipping_date=2026-05-08 | — |
| 10 | PASS | webhook status=200 body='{"status": "ok"}' | — |
| 11 | PASS | chatter has 9 message(s) on sale.order id=42 | — |
