...
- ⏳ **P1-03 Tracking Dashboard** (Spec 003 US2) — next per critical path for email-only E2E. Operators write tracking numbers via list + bulk-mark-shipped (T035) excluding pending-address rows.
