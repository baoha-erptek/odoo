"""Odoo discovery shim for P-BUG-ESTY-188 iter2 listing-currency bootstrap.
...
sibling package ``migrations/_19_0_2_34_0/`` so Phase 2 ORM tests can call
it directly without going through Odoo's upgrade pipeline.
"""
